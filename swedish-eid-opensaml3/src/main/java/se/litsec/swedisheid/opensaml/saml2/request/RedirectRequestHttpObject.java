...
public class RedirectRequestHttpObject<T extends RequestAbstractType> extends HTTPRedirectDeflateEncoder implements RequestHttpObject<T> {
   ...
   */
  public RedirectRequestHttpObject(T request, String relayState, PrivateKeyEntry signatureCredentials, String endpoint)
    ...
    Endpoint endpointObject = SAMLUtils.createSamlObject(Endpoint.class);
    ...
    if (signatureCredentials != null) {
      ...
      signatureCreds.setSigningCredentials(Arrays.asList(new BasicX509Credential((X509Certificate) signatureCredentials.getCertificate(),
        signatureCredentials.getPrivateKey())));
