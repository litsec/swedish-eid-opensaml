...
import se.litsec.swedisheid.opensaml.saml2.metadata.spring.LogoFactoryBeanTest;
...
public class UIInfoBuilderTest extends OpenSAMLTestBase {
  ...
  public void testSimple() throws Exception {
    ...
    LocalizedString description = new LocalizedString("Litsecs tjänst för legitimering");

    Logo[] logos = new Logo[] {
        createLogo("http://www.litsec.se/logo-sv.jpg", null, 16, 16),
        createLogo("http://www.litsec.se/logo-sv-large.jpg", null, 200, 200) };

    LocalizedString informationURL = new LocalizedString("http://www.litsec.se");
    ...
    assertUIInfo(uiInfo, displayNames, null, keywords, new LocalizedString[]{ description }, logos, new LocalizedString[]{ informationURL }, null);
  }

  public static Logo createLogo(String url, String language, Integer height, Integer width) {
    Logo logo = SAMLUtils.createSamlObject(Logo.class);
    logo.setURL(url);
