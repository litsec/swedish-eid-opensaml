...
import se.litsec.swedisheid.opensaml.TestHelper;
import se.litsec.swedisheid.opensaml.saml2.LocalizedString;
import se.litsec.swedisheid.opensaml.saml2.metadata.builders.UIInfoBuilderTest;
...
public class UIInfoFactoryBeanTest extends OpenSAMLTestBase {
  ...
  public void testSimple() throws Exception {
    ...
    factory.setInformationURL(informationURL);
